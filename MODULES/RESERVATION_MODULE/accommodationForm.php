    ...
    <div class="product-container">
      <div class="card">
        ...
        <div>
          ...
          <h3>RM <?php echo number_format($accommodation['accommodationPrice'], 2); ?> / night</h3>
          <p><?php echo htmlspecialchars($accommodation['accommodationDesc']); ?></p>

          <!-- Booking form -->
          <form method="post" action="accommodation_cart_action.php?action=add&id=<?php echo $accommodation['accommodationID']; ?>">
