...
if (!empty($_GET["action"])) {
  switch ($_GET["action"]) {
      // Add food
      case "add":
          if (!empty($_POST["quantity"]) && isset($_POST["id"])) {
              $foodID = $_POST["id"]; // Get the food ID from POST
              ...
              if ($row) {
                  ...
                  if (!empty($_SESSION["cart_item"])) {
                      // Check if current cart contains the food or not
                      if (array_key_exists($actID, $_SESSION["cart_item"])) {
                          // Update quantity
                          $_SESSION["cart_item"][$actID]["quantity"] = $quantityToAdd; 
                      } else {
                          // Add new food to the current cart if it doesn't exist
                          $_SESSION["cart_item"] = array_merge($_SESSION["cart_item"], $itemArray);
                      }
                  } else {
                      // Add to cart if no food exists in current cart yet
        ...
        // Delete all foods from the cart
        case "empty":
            unset($_SESSION["cart_item"]);
            break;
    }
    ...
    <div class="cart-action">
        ...
        if (isset($_SESSION["cart_item"])) {
            ...
            <table>
                ...
                foreach ($_SESSION["cart_item"] as $item) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="food_cart_action.php?action=remove&foodID=<?php echo $item['foodID']; ?>">
                ...
                <tr id="checkout-cart">
                    ...
                    <td colspan="1">
                    <form method="post" action="../PAYMENT_MODULE/payment.php?total_price=<?php echo $total_price; ?>&type=food">
            ...
            <p id="cart-misc-button">
                <a href="food_cart_action.php?action=empty">
            ...
            <p id="cart-misc-button">
                <a href="../FOOD_MODULE/foodList.php">
